...
var PrerenderPlugin = require('./PrerenderPlugin');
...
module.exports = {
	...
	devtool: null,
	entry: {
		// Explicitly name the main chunck as such to ensure PrerenderPlugin finds it.
		main: [
			...
			path.resolve(enact.prerender || pkg.main || 'index.js')
		]
	},
	output: {
	...
	plugins: [
		...
		new HtmlWebpackPlugin({
			...
			title: enact.title || '',
			inject: false,
			template: path.join(__dirname, 'html-template-prerender.ejs'),
			xhtml: true,
			minify: {
				removeComments: true,
